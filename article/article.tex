...
% Packages I've been using for differen reasons
\usepackage{hyperref}
\usepackage{dcolumn}
\usepackage{graphicx}
\usepackage{float}
...
\citet{schuberth2013challenging,
zizumbo2017community,smith2019contradictions,cohen2022collective}.} This
omission is significant not only because violence is pervasive in weak states,
but it also comes at a great cost \citep{blair2017predicting}. 
...
barbara2015vigilantes}. From 2011 to 2015, Brazil registered about 2,500
lynching episodes, and 173 people were killed by angry mobs in 2015
...
more than thirty years, these figures are not only the highest in the country's
...
women and girls, elderly women, and even members of the local police
...
us to precisely estimate the size of effects and compare different theoretical
...
%%%%DELETE OR REVISE In this respect, interventions that reduce popular support for extrajudicial violence can have a substantial impact on citizen welfare and potentially increase state legitimacy in young democracies.
