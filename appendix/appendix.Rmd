...
packages <- c("cjoint", "cregg", "estimatr", "kableExtra",
...
stargazer(m1, m2, m3, m4, se = starprep(m1, m2, m3, m4),
          ...
          header = FALSE, align = TRUE, label = "exp02main",
          title = "Experiment 02 -- Main Results", style = "apsr",
          dep.var.labels = "Lynching Support",
...
stargazer(m1, m2, m3, m4, m5, se = starprep(m1, m2, m3, m4, m5),
          ...
          header = FALSE, align = TRUE, label = "exp02demo1",
          ...
          covariate.labels = c("Male", "Age (years)", "Black", "Mixed race",
                               ...
                               "Graduate school", "3,001 to 5,000 BRL",
                               "5,000+ BRL"), style = "apsr",
...
stargazer(m6, m7, m8, m9, se = starprep(m6, m7, m8, m9),
          ...
          header = FALSE, align = TRUE, label = "exp02demo2",
          title = "Experiment 02 -- Demographic Characteristics and Lynching Support",
          dep.var.labels = "Lynching Support", style = "apsr",
          covariate.labels = c("Left", "Center-Left", "Center-Right", "Right")
          column.sep.width = "2pt", notes = "Robust standard error in parentheses.",
