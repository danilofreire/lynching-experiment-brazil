...
their profile choices. We added a textbook after each conjoint and informed
...
a central cluster that describe crime and victim characteristics and includes
...
related to the crime he/she committed, specially the crime victim. There is
...
topics in this estimation. The first refers to victims, and include words for
children, life, and victim (along with possible variations). The second topic
describes crime characteristics with words such as murder, rape, kill, molest,
and steal. The next group has four keywords that describe lynching
perpetrators, and they are gangs, family, bystanders, and police. The fourth
topic includes terms to identify respondents who are against lynchings, and we
added against, none, do not agree, and choice as the seed terms. We see that
these groups have a large number of terms each, and that crime characteristics
is the topic that shows more often when our terms are applied.
...
keywords <- dictionary(list(Victim      = c("crian*", "vida*", "v*tima*"),
                            ...
                            Against     = c("contra", "nenhum*", "n*o concord*", "op**o")))
...
We do not find considerable heterogeneity in the these results. Overall, the
