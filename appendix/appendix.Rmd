...
In this subsection, we test whether our results vary according to individual characteristics, such as gender, age, race, income, support for death penalty, and the respondents' opinions on the judicial system and the police forces. All models report marginal means.
...
\footnotesize
```{r conjoint-income, warning=F, message=F, error=F, cache=T, fig.width=7, fig.height=6, fig.pos="H"}
# Model
cjdt <- full_join(conjoint_data, df1, by = "response_id") %>%
