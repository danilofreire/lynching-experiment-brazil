...
and R\$2,000 (US\$ 184 to US\$368) and `r df2[7, 3]*100`% with household incomes
...
\footnotesize
```{r conjoint-education, warning=F, message=F, error=F, cache=T, fig.width=7, fig.height=5.7, fig.pos="H"}
# Model
cjdt <- full_join(conjoint_data, df1, by = "response_id") %>%
  drop_na(education) %>%
...
\footnotesize
```{r conjoint-income, warning=F, message=F, error=F, cache=T, fig.width=7, fig.height=5.7, fig.pos="H"}
# Model
cjdt <- full_join(conjoint_data, df1, by = "response_id") %>%
...
estimates largely overlap across the four groups, although those who answered "Rather Not Say" are less favorable to lynching Indigenous criminals.
...
\footnotesize
```{r conjoint-policing, warning=F, message=F, error=F, cache=T, fig.width=7, fig.height=5.7, fig.pos="H"}
# Model
cjdt <- full_join(conjoint_data, df1, by = "response_id") %>%
...
\footnotesize
```{r conjoint-justice, warning=F, message=F, error=F, cache=T, fig.width=7, fig.height=5.6, fig.pos="H"}
# Model
cjdt <- full_join(conjoint_data, df1, by = "response_id") %>%
...
Table \ref{tab:exp02main} summarizes our results.
