...
mm_by <- cj(cjdt, fm, id = ~response_id, estimate = "mm",
            h0 = 0.5, by = ~Gender)
...
```{r conjoint-males, warning=F, message=F, error=F, cache=T, fig.pos = "H"}
...
\footnotesize
```{r conjoint-age, warning=F, message=F, error=F, cache=T, fig.width=7, fig.height=6, fig.pos="H"}
# Model
cjdt <- full_join(conjoint_data, df1, by = "response_id") %>%
  drop_na(age) %>%
  mutate(age2 = case_when(age >= 18 & age <= 34 ~ "18-34",
                          age >= 35 & age <= 54 ~ "35-54",
                          age >= 55 ~ "55 plus",
                          TRUE ~ as.character(age)))
cjdt$Age <- factor(cjdt$age2)
mm_by <- cj(cjdt, fm, id = ~response_id, h0 = 0.5,
            estimate = "mm", by = ~Age)
...
\footnotesize
```{r conjoint-race, warning=F, message=F, error=F, cache=T, fig.width=7, fig.height=7, fig.pos="H"}
# Model
cjdt <- full_join(conjoint_data, df1, by = "response_id") %>%
  drop_na(race) %>%
...
```{r conjoint-white, warning=F, message=F, error=F, cache=T, fig.pos="H"}
...
\footnotesize
```{r conjoint-education, warning=F, message=F, error=F, cache=T, fig.width=7, fig.height=5.6, fig.pos="H"}
# Model
cjdt <- full_join(conjoint_data, df1, by = "response_id") %>%
  drop_na(education) %>%
...
```{r conjoint-degree, warning=F, message=F, error=F, cache=T, fig.width=7, fig.height=6, fig.pos="H"}
...
\footnotesize
```{r conjoint-income, warning=F, message=F, error=F, cache=T, fig.width=7, fig.height=5, fig.pos="H"}
# Model
cjdt <- full_join(conjoint_data, df1, by = "response_id") %>%
...
\footnotesize
```{r conjoint-penalty, warning=F, message=F, error=F, cache=T, fig.width=7, fig.height=6, fig.pos="H"}
# Model
cjdt <- full_join(conjoint_data, df1, by = "response_id") %>%
  drop_na(death_penalty)
cjdt$death_penalty <- factor(cjdt$death_penalty)
mm_by <- cj(cjdt, fm, id = ~response_id, estimate = "mm",
            h0 = 0.5, by = ~death_penalty)
...
```{r conjoint-deathrns, warning=F, message=F, error=F, cache=T, fig.pos = "H"}
...
```{r conjoint-deathyes, warning=F, message=F, error=F, cache=T, fig.pos = "H"}
...
```{r conjoint-victimization, warning=F, message=F, error=F, cache=T, fig.width=7, fig.height=6, fig.pos="H"}
# Model
cjdt <- full_join(conjoint_data, df1, by = "response_id")
cjdt$Previous_Victim <- factor(cjdt$previous_victim_dummy)

mm_by <- cj(cjdt, fm, id = ~response_id, estimate = "mm",
            h0 = 0.5, by = ~Previous_Victim)
...
```{r conjoint-victimizationyes, warning=F, message=F, error=F, cache=T, fig.pos = "H"}
mm_yes <- mm_by %>% filter(BY == "Yes")
table_mm_by(mm_yes, capt = "Marginal Means -- Support for Death Penalty: Rather Not Say")
```
\normalsize
...
\footnotesize
```{r conjoint-policing, warning=F, message=F, error=F, cache=T, fig.width=7, fig.height=6, fig.pos="H"}
# Model
cjdt <- full_join(conjoint_data, df1, by = "response_id") %>%
...
```{r conjoint-polvbad, warning=F, message=F, error=F, cache=T, fig.pos = "H"}
mm_vbad <- mm_by %>% filter(BY == "Very Bad")
table_mm_by(mm_vbad, capt = "Marginal Means -- Opinion on the Police: Very Bad")
```
\newpage

```{r conjoint-polvgood, warning=F, message=F, error=F, cache=T, fig.pos = "H"}
...
\footnotesize
```{r conjoint-justice, warning=F, message=F, error=F, cache=T, fig.width=7, fig.height=6, fig.pos="H"}
# Model
cjdt <- full_join(conjoint_data, df1, by = "response_id") %>%
...
```{r conjoint-justicevbad, warning=F, message=F, error=F, cache=T, fig.pos = "H"}
mm_vbad <- mm_by %>% filter(BY == "Very Bad")
...
```{r conjoint-justicevgood, warning=F, message=F, error=F, cache=T, fig.pos = "H"}
mm_vgood <- mm_by %>% filter(BY == "Very Good")
