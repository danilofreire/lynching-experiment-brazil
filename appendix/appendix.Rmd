...
relevant, as respondents do not mention them as much. The next words are
...
stargazer(m1, m2, m3, m4, se = starprep(m1, m2, m3, m4),
          p = starprep(m1, m2, m3, m4, se_type = "HC2", stat = "p.value"),
          header = FALSE, align = TRUE, label = "tab:exp03main",
          title = "Experiment 03 -- Main Results", style = "apsr",
          dep.var.labels = "\\textbf{Lynching Support}\\vspace{.5cm}",
