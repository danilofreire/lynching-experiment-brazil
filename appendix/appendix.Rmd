---
title: |
       | Supplementary Materials for "Vigilantism, Institutions, and Culture: Understanding Attitudes towards Lynching in Brazil"
author:
...
present in "_Vigilantism, Institutions, and Culture: Understanding Attitudes
towards Lynching in Brazil_". This file also includes the descriptive
statistics of our sample, the average marginal component effects (AMCEs) for
our conjoint experiment, and additional subgroup analyses for all three
experiments.
...
stargazer(m1, m2, m3, m4, se = starprep(m1, m2, m3, m4),
          p = starprep(m1, m2, m3, m4, stat = "p.value"),
          header = FALSE, align = TRUE, label = "tab:exp01main",
          title = "Experiment 01 -- Main Results", style = "apsr",
...
Here we estimate the effect of gender, race, and political ideology on
lynching support. We find that males, blacks, and mixed race individuals are
more likely to endorse lynchings when compared to females and whites,
respectively. Left and center-left voters, in contrast, show lower support for
lynchings when compared to centrists.
...
m1 <- lm(exp01_outcomes ~ gender, data = df_exp01_group)
m2 <- lm(exp01_outcomes ~ relevel(race, ref = "White"), data = df_exp01_group)
m3 <- lm(exp01_outcomes ~ relevel(ideology, ref = "Center"), data = df_exp01_group)
m4 <- lm(exp01_outcomes ~ gender + relevel(race, ref = "White") +
         relevel(ideology, ref = "Center"), data = df_exp01_group)
...
stargazer(m1, m2, m3, m4, se = starprep(m1, m2, m3, m4), p = starprep(m1, m2, m3, m4, stat = "p.value"),
          ...
          covariate.labels = c("Male", "Asian", "Black", "Mixed Race",
